...
class BoundingBoxPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var box in boxes) {
      ...
      final right =
          ((actualLeft + actualWidth) * scaleX).clamp(0.0, size.width);
      final bottom =
          ((actualTop + actualHeight) * scaleY).clamp(0.0, size.height);
      ...
      if (right > left && bottom > top) {
        ...
        final textPainter = TextPainter(
          text: TextSpan(
            ...
            style: AppTextStyles.primaryTextStyle60016().copyWith(
              color: Colors.white,
        ...
        final clampedLabelY =
            labelY.clamp(0.0, size.height - textPainter.height);
